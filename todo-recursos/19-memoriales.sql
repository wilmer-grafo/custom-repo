SELECT *
FROM (SELECT NULL                           AS id_recurso_alzada,
             (CASE
             ...
             3                              AS id_region_recepcion,
             (CASE
                  WHEN (ct.motivo = 44 OR ct.motivo = 258) THEN 15
                  WHEN (ct.motivo = 6 OR ct.motivo = 645) THEN 29
                  WHEN (ct.motivo = 220 OR
                        ct.motivo = 221 OR
                        ct.motivo = 222 OR
                        ct.motivo = 223 OR
                        ct.motivo = 224 OR
                  ...
                  WHEN (ct.motivo = 43 OR
                        ct.motivo = 225 OR
                        ct.motivo = 252) THEN 33
                  ...
                  WHEN (ct.motivo = 9 OR ct.motivo = 358 OR ct.motivo = 424 OR ct.motivo = 425) THEN 41
                  WHEN (ct.motivo = 8 OR
                        ct.motivo = 10 OR
                        ct.motivo = 36 OR
                        ct.motivo = 51 OR
                  ...
                  WHEN (ct.motivo = 439 OR ct.motivo = 440 OR ct.motivo = 441 OR ct.motivo = 442 OR ct.motivo = 443)
                      THEN 43
                  WHEN (ct.motivo = 86 OR
                        ct.motivo = 87 OR
                        ct.motivo = 291 OR
                        ct.motivo = 340 OR
                        ct.motivo = 341 OR
                  ...
                  WHEN (ct.motivo = 31 OR
                        ct.motivo = 54 OR
                        ct.motivo = 135 OR
                        ct.motivo = 250
                      ) THEN 2
                  WHEN (ct.motivo = 19 OR
                        ct.motivo = 23 OR
                        ct.motivo = 269 OR
                        ct.motivo = 275 OR
                        ct.motivo = 276 OR
...
WHERE temp.id_recurso_jerarquico IS NOT NULL;
