SELECT 1                                                                              AS id_tipo_presentacion,
       ...
       (CASE
            ...
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'cvalle' THEN 341
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'cvalleae' THEN 341
            ...
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'cpradoa' THEN 345
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'cprados' THEN 345
            ...
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'lespada' THEN 372
            ...
            WHEN LTRIM(RTRIM(ra.C_Usuario)) = 'mmoya' THEN 383
