...
WHERE  (C_Nro_Expediente LIKE 'ARIT-PND-%/2021%' OR C_Nro_Expediente LIKE 'ARIT-PND-%/2022%')
...
where (numero_recurso_alzada ilike 'ARIT-PND-%/2021%' OR numero_recurso_alzada ilike 'ARIT-PND-%/2022%')
