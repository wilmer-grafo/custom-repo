...
WHERE (ra.C_Nro_Expediente LIKE 'ARIT-CHQ-%/2021%' OR ra.C_Nro_Expediente LIKE 'ARIT-CHQ-%/2022%')
  AND (TRA.C_Nro_Expediente LIKE 'ARIT-CHQ-%/2021%' OR TRA.C_Nro_Expediente LIKE 'ARIT-CHQ-%/2022%')
  AND ra.N_Codigo_Tipo_Auto NOT IN (22, 23);
...
where (numero_recurso_alzada ilike 'ARIT-CHQ-%/2021%' or numero_recurso_alzada ilike 'ARIT-CHQ-%/2022%')
