...
FROM (SELECT C_Nro_Expediente, N_Codigo_Acto, C_Numero
      ...
      WHERE (C_Nro_Expediente LIKE 'ARIT-PTS-%/2021%' OR C_Nro_Expediente LIKE 'ARIT-PTS-%/2022%')
...
from (select numero_recurso_alzada, id
      ...
      where numero_recurso_alzada in (
          ...
          from alzada.alz_recursos_alzada
          where (numero_recurso_alzada ilike 'ARIT-PTS-%/2021%' OR numero_recurso_alzada ilike 'ARIT-PTS-%/2022%')
